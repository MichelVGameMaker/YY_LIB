...
enum EImGui_WindowFlags {
	...
	AlwaysVerticalScrollbar   = 1 << 14,  // Always shw vertical scrollbar (even if ContentSize.y < Size.y)
	AlwaysHorizontalScrollbar = 1 << 15,  // Always shw horizontal scrollbar (even if ContentSize.x < Size.x)
...
enum EImGui_ColorEditFlags
{
	  ...
	  NoSmallPreview  = 1 << 4,   //              // ColorEdit, ColorPicker: disable colored square preview next to the inputs. (e.g. to shw only the inputs)
	  NoInputs        = 1 << 5,   //              // ColorEdit, ColorPicker: disable inputs sliders/text widgets (e.g. to shw only the small preview colored square).
	  ...
	  AlphaBar        = 1 << 16,  //              // ColorEdit, ColorPicker: shw vertical alpha bar/gradient in picker.
